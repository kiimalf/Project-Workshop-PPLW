...
@section('content')
    <div class="page-header">
        <h3 class="page-title"> Edit Menu {{ $menu->nama_menu }}</h3>
    </div>
        ...
        <div class="col-lg-8 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="form" action="{{ route('vendor.menu.update', ['idvendor' => $menu->idvendor, 'idmenu' => $menu->idmenu]) }}" method="POST">
                        @csrf
                        @method('PUT')
                    ...
                    <a href="{{ route('vendor.menu.index', $menu->idvendor) }}" class="btn btn-light">
                        Kembali
                    </a>
