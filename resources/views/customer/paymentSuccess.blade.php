    ...
    <div class="col-lg-6">
        ...
        <div class="card mt-3">
            <div class="card-body text-center">
                <img src="{{ route('qrcode.generate', $pesanan->order_id) }}" alt="QR Code">
            </div>
        </div>
        ...
        <div class="card mt-3">
            <div class="card-body">
                <table class="table table-sm table-borderless">
                    <tr>
                        ...
                        <td class="text-right"><code>{{ $pesanan->order_id }}</code></td>
                    </tr>
                    <tr>
                        <td class="text-muted">Guest ID</td>
                        <td class="text-right"><strong>{{ $pesanan->customer->idcustomer }}</strong></td>
                    </tr>
                    <tr>
                        <td class="text-muted">Waktu</td>
                        <td class="text-right">{{ \Carbon\Carbon::parse($pesanan->created_at)->format('d M Y H:i') }}</td>
                    </tr>
                    <tr>
            ...
            <div class="card-footer d-flex gap-2 justify-content-center" style="gap:.5rem">
                <a href="{{ route('customer.catalog') }}" class="btn btn-success">Pesan Lagi</a>
